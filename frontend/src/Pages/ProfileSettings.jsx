    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-[var(--bg-primary)] transition-colors duration-300">
      <div className="max-w-7xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Column: Avatar Card (lg:col-span-4) */}
          <div className="lg:col-span-4 bg-[var(--surface-light)] rounded-2xl p-6 border border-[var(--border-light)] shadow-sm flex flex-col items-center text-center">
            <div className="relative group mb-6">
              <div className="w-36 h-36 rounded-full bg-gradient-to-br from-[var(--avatar-from)] to-[var(--avatar-to)] flex items-center justify-center overflow-hidden ring-4 ring-[var(--surface-light)] shadow-md">
                {profile.profile_pic ? (
                  <img
                    src={
              ...
              <label className="absolute bottom-1 right-1 p-2.5 bg-[var(--bg-secondary)] hover:bg-[var(--surface-hover)] rounded-full shadow-md cursor-pointer transition-transform transform hover:scale-105 border border-[var(--border-light)]">
            ...
            <div className="w-full pt-4 border-t border-[var(--border-light)] text-left">
              <h4 className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider mb-2">Account Type</h4>
              <p className="text-sm font-medium text-[var(--text-primary)] mb-4">Standard Account</p>
              
              {profile.status_message && (
                <>
                  <h4 className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider mb-2">Current Status</h4>
                  <p className="text-sm text-[var(--text-primary)] italic bg-[var(--surface-hover)] p-3 rounded-xl border border-[var(--border-light)]/50">
                    "{profile.status_message}"
                  </p>
                </>
              )}
          ...
          {/* Right Column: Fields and Security (lg:col-span-8) */}
          <div className="lg:col-span-8 space-y-8">
            {/* Form Fields Card */}
            <div className="bg-[var(--surface-light)] rounded-2xl p-6 md:p-8 border border-[var(--border-light)] shadow-sm">
              <h3 className="text-lg font-bold text-[var(--text-primary)] mb-6">Personal Details</h3>
            ...
            <div className="bg-[var(--surface-light)] rounded-2xl p-6 md:p-8 border border-[var(--border-light)] shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-xl bg-[var(--surface-hover)] border border-[var(--border-light)]/50 gap-4">
                <div>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[var(--surface-active)] hover:bg-[var(--border-light)] text-[var(--text-primary)] rounded-lg font-medium text-sm transition-colors border border-[var(--border-light)] self-start sm:self-auto shrink-0"
                >
                  Change Password
                </button>
              </div>
